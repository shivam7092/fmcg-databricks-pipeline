...
# MAGIC %md
# MAGIC ### Important required Libraries
...
# MAGIC %md
# MAGIC #### Load project Utilities & initilize Notebook Widgets
...
# reading the incremental data from s3 buckets landing folder
...
# writing the data back tp Delta table 
...
# MAGIC %md
# MAGIC #### Staging table to process just arrived incremental data 
...
df_orders = df_orders.filter(F.col("order_id").isNotNull())
...
# "Tuesday, Jul 01, 2025" -> "Jul 01, 2025"
...
# checking whats max and min dates are 
df_orders.agg(
...
# joining with the products table to get the products code 
...
# MAGIC %md
# MAGIC #### Staging table to process the arrived incremental data 
...
# pushing our data to the child gold table, using upsert operation
...
# MAGIC %md
# MAGIC ### Merging with the Parent company
...
# df_child -> your incrmental daily rows 
...
# writing back to gold layer by doing upsert operation 
